...
#define tCelltype_N_CELL            (5)  /* セルの個数  #_NCEL_# */
...
/* 属性アクセスマクロ #_AAM_# */
#define tCelltype_ATTR_id( p_that )	((p_that)->id)

#define tCelltype_GET_id(p_that)	((p_that)->id)
...
#define ATTR_id              tCelltype_ATTR_id( p_cellcb )
